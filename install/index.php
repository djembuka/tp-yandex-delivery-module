...
Class twinpx_yadelivery extends CModule
{
    ...
    function InstallEvents()
    {
		...
		/*EventManager::getInstance()->registerEventHandler("sale", "OnSalePayOrder",
		    $this->MODULE_ID, "TwinpxDelivery", "SalePayOrder");*/
    ...
    function UnInstallEvents()
    {
        ...
        /*EventManager::getInstance()->unRegisterEventHandler("sale", "OnSalePayOrder",
		    $this->MODULE_ID, "TwinpxDelivery", "SalePayOrder");*/
    ...
    {
        $arr = array(
            "reference_id" => array("D",/*"N",*/"R","W"),
            "reference"    => array(
                "[D] ".GetMessage("TWPX_PERM_D"),
//                "[N] ".GetMessage("TWPX_PERM_N"),
